-- Fix User Authentication and Organization Linking
-- Run this in your Supabase SQL Editor
-- This script fixes user profiles and organization linking after UUID migration
...
SELECT 'User authentication should now be working. Dashboard should show data correctly.' as status;
