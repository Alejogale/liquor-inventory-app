-- Fixed Team Management and User Invitation System
-- This fixes the invitation_token column issue

-- Drop the table if it exists and recreate it properly
DROP TABLE IF EXISTS user_invitations CASCADE;

-- Create user_invitations table with correct structure
...
CREATE INDEX idx_user_custom_permissions_organization_id ON user_custom_permissions(organization_id);
CREATE INDEX idx_user_custom_permissions_app_id ON user_custom_permissions(app_id);
