-- Country Club Guest Manager Database Schema
...
-- 13. Sample data insertion (commented out - uncomment if you want sample data)
-- INSERT INTO country_clubs (name, location, contact_person, contact_email, phone_number, organization_id) VALUES
-- ('Pebble Beach Golf Links', 'Pebble Beach, CA', 'John Smith', 'john@pebblebeach.com', '(555) 123-4567', (SELECT id FROM organizations LIMIT 1)),
-- ('Augusta National Golf Club', 'Augusta, GA', 'Sarah Johnson', 'sarah@augusta.com', '(555) 234-5678', (SELECT id FROM organizations LIMIT 1)),
-- ('St. Andrews Old Course', 'St. Andrews, Scotland', 'Mike Wilson', 'mike@standrews.com', '+44 20 1234 5678', (SELECT id FROM organizations LIMIT 1))
