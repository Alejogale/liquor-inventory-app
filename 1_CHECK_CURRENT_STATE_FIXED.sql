-- =====================================================
-- STEP 1: CHECK CURRENT STATE OF YOUR DATABASE (FIXED)
-- =====================================================
...
-- =====================================================
SELECT '📋 SAMPLE CATEGORIES:' as section;
SELECT name, organization_id FROM categories LIMIT 5;

SELECT '📋 SAMPLE SUPPLIERS:' as section;
SELECT name, organization_id FROM suppliers LIMIT 5;

SELECT '📋 SAMPLE INVENTORY:' as section;
SELECT brand, organization_id FROM inventory_items LIMIT 5;
