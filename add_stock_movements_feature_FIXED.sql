...
-- FIXED: Using BIGINT for foreign keys to match existing tables

CREATE TABLE IF NOT EXISTS stock_movements (
  id BIGSERIAL PRIMARY KEY,              -- Using BIGINT to match other tables

  -- WHAT was moved (BIGINT to match inventory_items)
  ...
  -- WHO did it (tracked via PIN) - Using UUID since user_profiles.id is UUID
  ...
  -- WHERE (BIGINT to match rooms table)
  ...
  -- Multi-tenancy (links to organization) - BIGINT to match organizations
...
-- ✅ FIXED: Uses correct ID types (BIGINT)
-- =====================================================
