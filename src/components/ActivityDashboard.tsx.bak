...
export default function ActivityDashboard({ userEmail }: ActivityDashboardProps) {
  ...
  if (loading) {
    return (
      <div className="text-center py-8">
        <div className="text-white/60">Loading activity dashboard...</div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white">Activity Dashboard & Reports</h2>
          <p className="text-white/60">Track inventory changes and send reports to managers</p>
        </div>
      ...
      {databaseError === 'table_missing' && (
        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="text-yellow-200 font-medium">Activity Logging Setup Required</h4>
              <p className="text-yellow-300 text-sm mt-1">
                The activity_logs table doesn't exist yet. To enable activity tracking:
              </p>
              <ol className="text-yellow-300 text-sm mt-2 ml-4 list-decimal">
      ...
      {databaseError === 'generic_error' && (
        <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-red-200 font-medium">Database Error</span>
          </div>
      ...
      {reportSent && (
        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-green-200 font-medium">Report sent successfully!</span>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {managerEmails.map((email) => (
              <div key={email} className="flex items-center space-x-2 bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full">
        ...
        <div className="p-6">
          {databaseError ? (
            <div className="text-center py-8">
              ...
              <p className="text-white/60">Activity logging not yet set up</p>
              ...
              {activities.map((activity) => (
                <div key={activity.id} className="flex items-start space-x-4 p-4 bg-white/5 rounded-lg border border-white/10">
                  ...
                  <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 mt-1 text-sm">
                        ...
                        {activity.change_type && (
                          <span className={`px-2 py-1 rounded text-xs ${
                            activity.change_type === 'scan' ? 'bg-green-500/20 text-green-300' :
                            activity.change_type === 'button' ? 'bg-blue-500/20 text-blue-300' :
                    ...
                    <div className="flex items-center space-x-2 mt-2 text-sm text-white/50">
