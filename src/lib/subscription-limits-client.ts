...
/**
 * Client-side function to check if organization can add more storage areas
 */
...
/**
 * Client-side function to check if organization can add more inventory items
 */
...
/**
 * Client-side function to check if organization can add more users
 */
